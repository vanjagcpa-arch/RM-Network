    ...
    <div className="p-8 max-w-3xl space-y-8">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3 rounded-lg bg-violet-50 border border-violet-100 p-4">
            <Info className="h-4 w-4 text-violet-600 flex-shrink-0 mt-0.5" />
            <div className="text-sm text-violet-800">
              <p className="font-medium">How to import into Ascora</p>
              <ol className="mt-1 space-y-1 list-decimal list-inside text-violet-700">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select value={filterStatus} onChange={(e) => setFilterStatus(e.target.value)}
                className="flex h-9 w-full rounded-md border border-slate-200 bg-white px-3 py-1 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-violet-500">
