  ...
  return (
    <div className="p-8 space-y-7">
      ...
      <div className="flex items-start justify-between">
        ...
        <Link
          href="/jobs/new"
          className="inline-flex items-center gap-2 rounded-lg bg-violet-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-violet-700 active:bg-violet-800 transition-colors"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="divide-y divide-slate-50">
            {todayJobs.length === 0 ? (
              <div className="px-5 py-10 text-center">
                ...
                <Link href="/jobs/new" className="mt-3 inline-block text-sm text-violet-600 hover:underline font-medium">
                  Schedule a job →
                </Link>
              </div>
            ) : (
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100">
            ...
            <Link href="/jobs" className="text-xs text-violet-600 hover:underline flex items-center gap-0.5 font-medium">
          ...
          <div className="divide-y divide-slate-50">
            {recentJobs.length === 0 ? (
              <div className="px-5 py-10 text-center">
                ...
                <Link href="/jobs/new" className="mt-2 inline-block text-sm text-violet-600 hover:underline font-medium">
