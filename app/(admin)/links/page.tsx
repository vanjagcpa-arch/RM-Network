              ...
              <div className="flex gap-2">
                {WEEKDAYS.map((day, i) => (
                  <button
                    ...
                    className={`px-2.5 py-1.5 rounded-md text-xs font-medium transition-colors ${form.allowedWeekdays.includes(i) ? "bg-violet-600 text-white" : "bg-slate-100 text-slate-600 hover:bg-slate-200"}`}
                  >
                    {day}
                  </button>
                ))}
